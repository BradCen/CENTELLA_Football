...
class FootballIntelligencePlatform:
    """Unified V30 entry point from synchronized tracking to coach-facing intelligence."""

    engine: AnalyticsEngine = field(default_factory=AnalyticsEngine)
    schema_version: str = "30.0.0"
    ...
    def _finalize(self, analysis: dict) -> dict:
        ...
        return {
            "platform": {
                ...
                "layers": ["vision_contract", "event_inference", "football_analytics", "player_intelligence", "performance", "coach_intelligence"],
            },
            "provenance": {
